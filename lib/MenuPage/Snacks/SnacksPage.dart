...
class SnacksMenuPage extends ConsumerStatefulWidget {
...
class _FoodMenuPageState extends ConsumerState<SnacksMenuPage> {
  @override
  void initState() {
    super.initState();
    Future.microtask(() {
  ...
  Widget build(BuildContext context) {
    final menuItemsAsyncValue = ref.watch(SnaksFilterProvider);
          ...
          Expanded(
            child: menuItemsAsyncValue.when(
              ...
              loading: () => const Center(
                  child:
                      LoadingWidget(message: "Blending wellness for you...")),
