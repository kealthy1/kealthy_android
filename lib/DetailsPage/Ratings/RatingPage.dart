  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return orderStatus.when(
        data: (shouldShowReview) {
          ...
          final productReviewState = ref.watch(productReviewProvider);
          final notifier = ref.read(rateProductProvider.notifier);

          if (productReviewState.isLoading) {
            return const Center(
          ...
          final productNames = productReviewState.productNames;
              ...
              body: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return FutureBuilder<String?>(
                    future:
                        FirestoreService.instance.fetchImageUrl(productName),
                                          ...
                                          : () async {
                                              final prefs =
                                                  await SharedPreferences
                                                      .getInstance();
                                              final customerName = prefs.getString("name");
