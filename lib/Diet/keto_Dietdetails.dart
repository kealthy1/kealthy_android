...
class ketoDietNotifier extends StateNotifier<List<QueryDocumentSnapshot>> {
  ketoDietNotifier() : super([]) {
    fetchAllMeals();
  }
...
final ketoDietProvider =
    StateNotifierProvider<ketoDietNotifier, List<QueryDocumentSnapshot>>((ref) {
  return ketoDietNotifier();
});

class ketoDietDetailsPage extends ConsumerWidget {
  const ketoDietDetailsPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final meals = ref.watch(ketoDietProvider);
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Vegan Diet Plan'),
      ),
      body: Padding(
          ...
          children: [
            TypeAheadField<String>(
              ...
              onSelected: (suggestion) {
                ...
                ref
                    .read(ketoDietProvider.notifier)
                  ...
                  child: TextField(
                    ...
                    decoration: InputDecoration(
                        ...
                        suffixIcon: IconButton(
                          ...
                          onPressed: () {
                            controller.clear();
                            ref.read(ketoDietProvider.notifier).fetchAllMeals();
                          },
                        ),
