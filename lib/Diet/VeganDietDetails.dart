...
class VeganDietNotifier extends StateNotifier<List<QueryDocumentSnapshot>> {
  VeganDietNotifier() : super([]) {
    fetchAllMeals();
  }
...
final veganDietProvider =
    StateNotifierProvider<VeganDietNotifier, List<QueryDocumentSnapshot>>(
        (ref) {
  return VeganDietNotifier();
});

class VeganDietDetailsPage extends ConsumerWidget {
  const VeganDietDetailsPage({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    final meals = ref.watch(veganDietProvider);
